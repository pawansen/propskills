...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
	...
	<div class="clearfix mt-2 mb-2" >
		...
		<div class="float-right">
			<button ng-if="data.dataList.length" class="btn btn-default btn-secondary btn-sm ng-scope" data-toggle="modal" data-target="#filter_model"><img src="asset/img/search.svg"></button>
			...
			<thead>
				<tr>
					...
					<th style="width: 70px;" class="text-center">Fee</th>
                                        <th style="width: 70px;" class="text-center">Admin Percentage</th>
					...
					<td class="text-center">
						<div class="dropdown" ng-if="row.Status=='Pending'">
							...
							<div class="dropdown-menu dropdown-menu-left">
								<a class="dropdown-item" href="" ng-click="loadFormEdit(key, row.ContestGUID)">Edit</a>
