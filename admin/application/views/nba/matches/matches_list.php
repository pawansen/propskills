...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
	...
	<div class="clearfix mt-2 mb-2" ng-if="data.dataList.length">
		...
		<div class="float-right">
			<form id="filterForm" role="form" autocomplete="off" ng-submit="applyFilter('Keyword')" class="ng-pristine ng-valid">
					...
					<td class="text-center">
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-left">
								...
								<a class="dropdown-item" target="_blank" href="nba/players?MatchGUID={{row.MatchGUID}}" >Players</a>
							</div>
						</div>
					</td>
				</tr>
			...
			<div class="modal-content">
				...
				<form id="filterForm1" role="form" autocomplete="off" class="ng-pristine ng-valid">
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-success btn-sm" data-dismiss="modal" ng-disabled="editDataLoading" ng-click="applyFilter('Keyword')">Apply</button>
					</div>
	...
	<div class="modal fade" id="edit_model">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title h5">Edit Matches</h3>     	
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
