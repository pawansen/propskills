<header class="panel-heading">
  <h1 class="h4">Contest Game Templates</h1>
</header>
...
<!--			<button class="btn btn-success btn-sm ml-1" ng-click="loadFormAdd();">Add Contest</button>-->
            <button class="btn btn-success btn-sm ml-1" ng-click="loadFormAddContest();">Add Contest Game Templates</button>
		</div>
		<div class="float-right">
	...
	<nav>
        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
           <!--  <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#" role="tab" aria-controls="nav-home" aria-selected="true" ng-click="applyFilter('Pending');"></a> -->
...
<!-- 					<td class="text-center"><span ng-class="{Pending:'text-danger', Running:'text-info',Cancelled:'text-danger',Completed:'text-success'}[row.AuctionStatus]">{{row.AuctionStatus}}</span></td> -->
					...
					<td class="text-center"><span ng-class="{Pending:'text-danger', Active:'text-success',Inactive:'text-danger',Completed:'text-success'}[row.Status]">{{row.Status}}</span></td>
					<td class="text-center">
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-left">
								<a class="dropdown-item" href="" ng-click="loadFormEditContest(key, row.PreContestID)">Edit</a>
								<a class="dropdown-item" href="" ng-click="loadFormStatus(key, row.PreContestID)">Status</a>
<!-- 								<a class="dropdown-item" href="" ng-click="editStatus('Cancelled',row.PreContestID,'delete')">Delete</a>
								<a class="dropdown-item" href="" ng-if="row.Status=='Cancelled'" ng-click="deleteData(row.PreContestID)">Delete</a> -->
							</div>
						</div>
