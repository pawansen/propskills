app.controller('PageController', function ($scope, $http,$timeout){
    ...
    /*list append*/
    $scope.StatusID = 2;//Default Running
    $scope.getList = function ()
    {
        ...
        $http.post(API_URL+'admin/nba/matches/getMatches', data, contentType).then(function(response) {
            var response = response.data;
    ...
    $scope.editData = function ()
    {
        ...
        $http.post(API_URL+'admin/nba/matches/changeStatus', data, contentType).then(function(response) {
            var response = response.data;
            if(response.ResponseCode==200){ /* success case */               
