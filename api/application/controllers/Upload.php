...
class Upload extends API_Controller_Secure
{
	...
	*/
	public function image_post()
	{
		...
		$MediaDetails =  $this->Media_model->uploadFile($this->SessionUserID, $this->SectionData['SectionID'], APPPATH.'../uploads/temp/','gif|jpg|png|jpeg',@$this->Post);
		if(!$MediaDetails){
			...
			switch ($this->Post['Section']) {
				...
				case 'BankDetail':
					...
					if($this->Post['Section']=='PAN'){
						...
						$this->Notification_model->addNotification('verify', 'License Uploaded', '125', '125','', $this->SessionUserID. ', just uploaded their license for Verification');
					}else{
