<header class="panel-heading">
    <h1 class="h4">Snake Draft Contest Edit</h1>
</header>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <p class="text-primary">{{formData.TeamNameLocal}} <strong>v/s</strong> {{formData.TeamNameVisitor}}</p>
                    </div>
                </div>
...
<!--                             <option value="RoundRobin" ng-selected="formData.ScoringType == 'RoundRobin' ? 'true' : 'false'">Round Robin</option> -->
                        </select>
                    </div>
                </div>
