...
class PreContest extends API_Controller_Secure {
    ...
    public function edit_post() {
        ...
        $this->form_validation->validation($this);  /* Run validation */
        /* Validation - ends */
        $this->PreContest_model->updateContest($this->Post, $this->SessionUserID, $this->Post['PreContestID']);
    ...
    public function editAdminFee_post() {

        /* Validation section */
        $this->form_validation->set_rules('PreContestID', 'PreContestID', 'trim|required');
        $this->form_validation->validation($this);  /* Run validation */
        /* Validation - ends */
        $this->PreContest_model->updateContestAdminFee($this->Post, $this->SessionUserID, @$this->PreContestID);
        $this->Return['Message'] = "Contest updated successfully.";
    }
    ...
    public function cancel_post() {
        ...
        /* Cancel Contests */
        $this->PreContest_model->statusUpdateContest(@$this->Post,$this->Post['PreContestID']);
        $this->Return['Message'] = "Contest updated successfully.";
    }
    ...
    public function getContests_post() {
        ...
        // }
        // $StatusID = '';
        $ContestData = $this->PreContest_model->getPreContest(@$this->Post['Params'], array_merge($this->Post, array('LeagueType' => 'Draft', 'SeriesID' => $this->SeriesID, 'UserID' => @$this->UserID, 'SessionUserID' => $this->SessionUserID,'StatusID' => @$this->StatusID)), TRUE, @$this->Post['PageNo'], @$this->Post['PageSize']);
    ...
    public function getContest_post() {
        ...
        /* Get Contests Data */
        $ContestData = $this->PreContest_model->getPreContest(@$this->Post['Params'], array_merge($this->Post, array('PreContestID' => @$this->Post['PreContestID'], 'MatchID' => @$this->MatchID, 'SessionUserID' => $this->SessionUserID)));
        if (!empty($ContestData)) {
