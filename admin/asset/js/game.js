app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getList = function ()
    {
        ...
        $http.post(API_URL+'category/getGames', data, contentType).then(function(response) {
            var response = response.data;
    ...
    $scope.loadFormEdit = function (Position, CategoryGUID)
    {
        ...
        $http.post(API_URL+'category/getGame', 'SessionKey='+SessionKey+'&GameID='+CategoryGUID, contentType).then(function(response) {
            var response = response.data;
    ...
    $scope.editData = function ()
    {
        ...
        $http.post(API_URL+'admin/category/editGame', data, contentType).then(function(response) {
            var response = response.data;
            if(response.ResponseCode==200){ /* success case */               
                alertify.success(response.Message);
