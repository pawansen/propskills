...
class Utilities extends API_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('Sports_football_model');
    }

    public function setSheet_get(){
       ...
       // $client->setScopes([\Google_Service_Sheets::SPREADSHEETS]);
        ...
        $requestBody->setValues(["values" => ["a", "c"]]);
    ...
    */
    ...
    /*
      ...
      URL: 			/api/utilities/getTeamsLive
     */
    ...
    public function getMatchesLive_get() {
        ...
        if (SPORTS_API_NFL) {
            $MatchesData = $this->Sports_football_model->getMatchesLiveNfl($CronID);
        }
        if (SPORTS_API_NCAAF) {
            $MatchesData = $this->Sports_football_model->getMatchesLiveNcaaf($CronID);
        }
        if (SPORTS_API_NFL_GOALSERVE) {
            $MatchesData = $this->Sports_football_model->getMatchesLiveNflGoalserve($CronID);
        }
        ...
        /*
      Description:  Cron jobs to get players data FOOTBALL. NEW CRON
      URL:      /api/utilities/getPlayersLive
     */

    public function getPlayersLiveByTeam_get() {
        $CronID = $this->Utility_model->insertCronLogs('getPlayersLiveByTeam');
        if (SPORTS_API_NFL) {
            $PlayersData = $this->Sports_football_model->getPlayersLiveByTeamNfl($CronID);
        }
        if (SPORTS_API_NCAAF) {
            $PlayersData = $this->Sports_football_model->getPlayersLiveByTeamNcaaf($CronID);
        }
        if (SPORTS_API_NFL_GOALSERVE) {
            $PlayersData = $this->Sports_football_model->getPlayersLiveByTeamNflGoalserve($CronID);
        }
    ...
    public function getPlayersLiveByTeamInjuriesAndStates_get() {
        $CronID = $this->Utility_model->insertCronLogs('getPlayersLiveByTeamInjuriesAndStates');
        if (SPORTS_API_NFL_GOALSERVE) {
            $PlayersData = $this->Sports_football_model->getPlayersLiveByTeamInjuriesAndStates($CronID);
        }
        if (!empty($PlayersData)) {
            $this->Return['Data'] = $PlayersData;
        }
    ...
    public function getMatchesScoreLive_get() {
        $CronID = $this->Utility_model->insertCronLogs('getMatchesScoreLive');
        if (SPORTS_API_NFL) {
            $MatchesData = $this->Sports_football_model->getMatchesScoreLiveNfl($CronID);
        }
        if (SPORTS_API_NCAAF) {
            $MatchesData = $this->Sports_football_model->getMatchesScoreLiveNcaaf($CronID);
        }
        if (SPORTS_API_NFL_GOALSERVE) {
            $MatchesData = $this->Sports_football_model->getMatchesScoreLiveNflGoalServeByDate($CronID);
            $MatchesData = $this->Sports_football_model->getMatchesScoreLiveNflGoalServe($CronID);
        }
        if (!empty($MatchesData)) {
            $this->Return['Data'] = $MatchesData;
        }
    ...
    /*
      Description: 	Cron jobs to get matches data FOOTBALL. NEW CRON
      URL: 			/api/utilities/contestUserTeamCalculetePoints
     */

    public function contestUserTeamCalculetePoints_get() {
        $CronID = $this->Utility_model->insertCronLogs('contestUserTeamCalculetePoints');
        if (SPORTS_API_NFL) {
            $MatchesData = $this->Sports_football_model->contestUserTeamCalculetePointsNfl($CronID);
        }
        if (SPORTS_API_NCAAF) {
            $MatchesData = $this->Sports_football_model->contestUserTeamCalculetePointsNcaaf($CronID);
        }
        if (SPORTS_API_NFL_GOALSERVE) {
            $MatchesData = $this->Sports_football_model->contestUserTeamCalculetePointsGoalServe($CronID);
        }
        if (!empty($MatchesData)) {
            $this->Return['Data'] = $MatchesData;
        }
    ...
    public function getPlayerPoints_get() {
        ...
        $this->Sports_football_model->getPlayersPointGoalServe($CronID);
    ...
    /*
      ...
      Cron Status : Run Every 1 Hour
     */
    public function autoContestCompleteWeeklyDailyWinningAssign_get() {
        $this->SnakeDrafts_model->autoCompleteWeeklyDaily();
        $this->Sports_football_model->setContestWinners();
    }
    ...
    public function amountDistributeContestWinner_get() {
        ...
        $this->Sports_football_model->amountDistributeContestWinner($CronID);
        $this->Utility_model->updateCronLogs($CronID);
    }
    ...
    /*
      ...
      URL : api/utilities/contestStanding/
     */
