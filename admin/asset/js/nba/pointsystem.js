app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getList = function ()
    {
        ...
        $http.post(API_URL+'nba/sports/getPoints', data, contentType).then(function(response) {
    ...
    $scope.editData = function (PointsTypeGUID,PointsMatchType,PointsValue)
    {
        ...
        $http.post(API_URL+'nba/admin/points/update', data, contentType).then(function(response) {
            var response = response.data;
    ...
    $scope.updateGeneralPoints = function(){
        ...
        $http.post(API_URL+'admin/nba/points/update', data, contentType).then(function(response) {
            var response = response.data;
            if(response.ResponseCode==200){ /* success case */               
               alertify.success(response.Message);
            }else{
    ...
    $scope.updateBonusPoint = function(){
        ...
        $http.post(API_URL+'nfl/admin/points/update', data, contentType).then(function(response) {
            var response = response.data;
            if(response.ResponseCode==200){ /* success case */               
               alertify.success(response.Message);
            }else{
